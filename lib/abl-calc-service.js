...
(function(){
  angular.module('ablsdk').service('ablcalc', function($xabl){
    ...
    return function(charges){
      var makeEditable, state, totalWithoutTaxesfees, calcTaxFee, calcTaxesFees, showPrice, calcPrice, showAddonPrice, calcAddonPrice, totalAddons, calcTotal, coupon;
      ...
      calcTotal = function(){
        ...
        return total - coupon.calc(total);
      };
      coupon = {
        codes: [],
        calc: function(total){
