...
(function(){
  angular.module('ablsdk').service('ablcalc', function($xabl){
    ...
    return function(charges){
      var makeEditable, state, calcSubtotal, calcTaxFee, calcTaxesFees, showPrice, calcPrice, showAddonPrice, calcAddonPrice, totalAddons, calcCoupon, calcTotal, coupon;
