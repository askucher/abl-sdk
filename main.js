...
angular.module('ablsdk').service('ablcalc', function($xabl, $timeout){
  ...
  return function(inputCharges){
    var charges, makeEditable, byPrice, state, calcSubtotal, calcTaxFee, calcTaxesFees, showPrice, calcPrice, showAddonPrice, calcAddonPrice, totalAddons, calcCoupon, calcTotal, calcPreviousTotal, calcBalanceDue, coupon;
