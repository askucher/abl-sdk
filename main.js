...
angular.module('ablsdk').factory('debug', function(enabledDebug){
  return function(input){
    ...
    if (enabledDebug) {
      ...
      if (mtch) {
        console.log(window['catch'], mtch != null ? (ref$ = mtch[0]) != null ? typeof ref$.replace == 'function' ? (ref1$ = ref$.replace('<<', '')) != null ? typeof ref1$.replace == 'function' ? ref1$.replace('>>', '') : void 8 : void 8 : void 8 : void 8 : void 8);
      }
      if (mtch && window['catch'] === mtch[0].replace('<<', '').replace('>>', '')) {
        ...
        case 'Function':
          return input();
        default:
          return typeof console != 'undefined' && console !== null ? (ref2$ = console.log) != null ? ref2$.apply(console, arguments) : void 8 : void 8;
        }
      }
    }
  };
