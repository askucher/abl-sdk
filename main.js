...
angular.module('ablsdk').service('ablcalc', function($xabl, $timeout, p, debug){
  ...
  return function(inputCharges, inputPayments, paid){
    ...
    calcBalanceDue = function(){
      return calcTotal() - (paid != null ? paid : 0);
    };
    adjustment = {
