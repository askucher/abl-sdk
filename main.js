...
angular.module('ablsdk').service('crud', function($xabl, $rootScope, debug, $mdDialog, safeApply, watcher){
  return function(url, initOptions){
    ...
    fetch = function(options){
      ...
      case 'Function':
        i.functionOptions = options;
        return fetch({});
      case 'Number':
        i.options.page = options;
        break;
      case 'Object':
        processOptions = $.extend({}, options, i.functionOptions());
        i.urlOptions = $.extend({}, typeof processOptions.$url == 'function' ? processOptions.$url({}, i.options.urlOptions) : void 8);
        delete options.$url;
