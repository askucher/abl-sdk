    ...
    fetch = function(options){
      ...
      case 'Object':
        debug({
          ...
          applied: i.getOptions(),
          extended: angular.extend({}, options, i.getOptions())
        });
        window.inputOptions = options;
        window.applied = i.getOptions();
        i.options = angular.extend({}, options, i.getOptions());
