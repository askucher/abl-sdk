...
angular.module('ablsdk').service('ablbook', function($xabl, p, stripe, debug, prefill){
  return function(activity, globalCallback){
    ...
    x$.handle = function(event){
      ...
      if (type === 'focus') {
        return typing(name);
      } else if (type === 'keyup' && name === 'expDate') {
        return expDateChanged(value);
      } else if (type === 'keyup' && name === 'card') {
        return cardChanged(value);
      }
    };
