    ...
    widget.load = function(config){
      return through(function(cb){
        return loader.activities(function(scope){
          ...
          scope.list);
          return widget.preferences = scope.preferences;
        });
      });
    };
    return {
  ...
  return function(activity, inputModel){
    ...
    skipSlots = function(){
      ...
      pref = (ref$ = (ref1$ = $rootScope.user) != null ? (ref2$ = ref1$.preferences) != null ? (ref3$ = ref2$.widget) != null ? (ref4$ = ref3$.display) != null ? ref4$.timeslot : void 8 : void 8 : void 8 : void 8) != null
        ? ref$
        : {};
      return pref.duration + pref.price + pref.availability + pref.startTime === 0 && activeSlots.length > 0;
    };
    select = function(day){
      model.value = day;
    ...
    showError = function(name, v){
      ...
      case !v.pattern:
        return (ref$ = (ref2$ = fields[name].messages) != null ? ref2$.pattern : void 8) != null
          ? ref$
          : "Please follow the example " + fields[name].example;
      case !v.minlength:
