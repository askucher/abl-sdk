...
angular.module('ablsdk').service('typecheck', function(debug, p){
  var parseType, identifierRegex, tokenRegex, parsedTypeCheck, any, all, isItNaN, types, defaultType, customTypes;
  parseType = (identifierRegex = /[\$\w]+/, (function(){
    ...
    return consumeTypes;
  }()), tokenRegex = RegExp('\\.\\.\\.|::|->|' + identifierRegex.source + '|\\S', 'g'), function(input){
    var tokens, e;
    if (!input.length) {
  ...
  parsedTypeCheck = (any = p.any, all = p.all, isItNaN = p.isItNaN, types = {
    Number: {
      typeOf: 'Number',
  ...
  }()), void 8, function(parsedType, input, options){
