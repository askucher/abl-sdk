...
// Generated by LiveScript 1.5.0
angular.module('ablsdk').service('ablapi', function($xabl, debug){
  return {
    timeslots: function(options){
      var req;
      debug('ablapi-timeslots', moment(options.startTime).clone().startOf('day').startOf('month').toISOString(), moment(options.endTime).clone().startOf('day').endOf('month').endOf('day').toISOString());
      req = $.param({
