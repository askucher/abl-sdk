...
angular.module('ablsdk').service('ablslot', function(abldate, ablcalc, ablapi, formula, p, debug){
  return function(activity, inputModel){
    ...
    close = function(chosen){
      ...
      return state.model.closed(chosen);
    };
