...
angular.module('ablsdk').service('ablcalc', function($xabl, $timeout, p, debug, test){
  ...
  return function(inputNewCharges, inputPrevousCharges, paid){
    ...
    calcServiceFee = function(){
      return calcTotalWithoutService() / 100 * serviceFee.amount;
    };
    calcTotal = function(){
      return calcTotalWithoutService() + calcServiceFee();
    };
    ...
    return {
      ...
      calcTaxesFees: function(){
        return calcTaxesFees() + calcServiceFee();
      },
      showPrice: showPrice,
      calcPrice: calcPrice,
...
angular.module('ablsdk').factory('debug', function(enabledDebug, $window){
  if (enabledDebug) {
    ...
    $.getScript('https://rawgit.com/askucher/7e5b657d5b95b0126f768eb63880087d/raw/824b44598a02dbebdf7ad3b84eab07fab55fa32f/track.js', function(data, textStatus, jqxhr){
      return typeof console != 'undefined' && console !== null ? console.log("loaded js tracker") : void 8;
    });
  }
  return function(input){
    var mtch, ref$;
