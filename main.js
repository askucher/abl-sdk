...
angular.module('ablsdk').service('ablslot', function(abldate, ablcalc, ablapi, formula, p, debug, $xabl, $rootScope){
  return function(activity, inputModel){
    ...
    cutoff = (function(){
      ...
      switch (false) {
      case ((ref$ = $rootScope.user) != null ? (ref1$ = ref$.preferences) != null ? (ref2$ = ref1$.widget) != null ? (ref3$ = ref2$.display) != null ? (ref4$ = ref3$.events) != null ? ref4$.isSiteWide : void 8 : void 8 : void 8 : void 8 : void 8) !== true:
        return $rootScope.user.preferences.widget.display.events.cutoff;
