...
// Generated by LiveScript 1.4.0
angular.module('ablsdk').service('ablsdk', function(ablslot, ablbook, loader, through, p, observ){
    ...
    activity = {
      ...
      load: function(config){
        return through(function(cb){
          return loader.activities(function(scope){
            p.each(bind$(activity.all, 'push'))(
            scope.list);
      ...
      choose: function(item){
        ...
        state.book = ablbook(item, function(status, data){
...
// Generated by LiveScript 1.4.0
angular.module('ablsdk').service('through', function(p){
  return function(func){
    var state;
    state = {
      result: null,
