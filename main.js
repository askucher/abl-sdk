...
angular.module('ablsdk').service('ablcalc', function($xabl, $timeout, p){
  ...
  return function(inputCharges, inputPayments){
    var payments, charges, ref$, makeEditable, byPrice, oldAmounts, exclude, availableAmounts, getAmounts, state, totalAdjustment, calcSubtotal, calcTaxFee, calcTaxesFees, showPrice, calcPrice, showAddonPrice, calcAddonPrice, totalAddons, calcCoupon, warning, calcTotal, calcPreviousTotal, calcBalanceDue, adjustment, coupon;
    payments = inputPayments != null
      ? inputPayments
      : [];
    charges = (ref$ = inputCharges != null ? inputCharges.filter(function(it){
    ...
    oldAmounts = function(type){
      ...
      p.groupBy(function(it){
        return it.name.concat(it.amount);
      })(
