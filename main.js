...
angular.module('ablsdk').service('ablbook', function($xabl, p, stripe, debug, prefill, ablcalc){
  return function(activity, globalCallback){
    var state, getDay, investigateDate, valid, issue, error, closeError, typing, resetIdenpotencyKey, few, sum, disabledOrder, cardify, expDateChanged, getEventInstanceId, cardChanged, stripeProcess, paymentSetup, checkout, agree, isError, required, showError, fields, tryCheckout, message, placeholder, x$;
    state = {
      triedCheckout: false,
      typing: '',
    ...
    required = function(name){
      switch (false) {
      case name !== 'agreed':
        return "Please confirm our terms and conditions";
      default:
