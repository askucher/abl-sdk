  ...
  return function(activity){
    ...
    state = {
      ...
      model: {
        ...
        charges: [],
        attendees: [],
        addons: activity.charges.filter(function(it){
          return it.type === 'addon';
        }).map(transformCharge),
        questions: (ref$ = activity.questions) != null
          ? ref$
          : [],
        bg: activity.image
      },
