  ...
  return function(inputNewCharges, inputPrevousCharges, paid){
    ...
    debug(function(){
      ...
      options = {
        customTypes: {
          CHARGE: {
            typeOf: '{_id: String, amount: Number, created: String, name: String, percentage: Boolean, status: String, type: String}',
            validate: function(){
              return true;
            }
          }
      ...
      typecheck('[CHARGE]', prevousCharges, options);
      return typecheck('[CHARGE]', newCharges, options);
    });
