...
angular.module('ablsdk').service('ablbook', function($xabl, p, stripe, debug, prefill, safeApply){
  return function(activity, globalCallback){
    var state, getDay, investigateDate, valid, issue, error, closeError, resetIdenpotencyKey, few, sum, disabledOrder, cardify, getEventInstanceId, bookingProcess, stripeProcess, paymentSetup, validate, bookingSuccess, checkout, agree, isError, showErrorLogical, showError, fields, tryCheckout, message, placeholder, x$;
    state = {
      triedCheckout: false,
      typing: '',
...
angular.module('ablsdk').service('ablslot', function(abldate, ablcalc, ablapi, formula, p, debug, $xabl){
  return function(activity, inputModel){
    ...
    transformSlot = curry$(function(actual, slot){
