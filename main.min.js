...
return function(){var t,e
for(e=n[0].apply(this,arguments),t=1;t<n.length;++t)e=n[t](e)
return e}}angular.module("ablsdk",[]),angular.module("ablsdk").service("ablcalc",function(n,t){var e
...
return u=moment(a).tz(t),n("timezone",t),r(u,u),e(u,moment(a)).toDate()}}}}),angular.module("ablsdk").filter("mdate",function(n){return function(n,t){return null!=n?n.format(t):null}}),angular.module("ablsdk").service("p",function(){var n
...
return e=n.$$phase,"$apply"===e||"$digest"===e?t():n.$apply(t)}}),angular.module("ablsdk").service("formula",function(n,t){var e,r
...
default:return"undefined"!=typeof console&&null!==console&&null!=(e=console.log)?e.apply(console,arguments):void 0}}}),angular.module("ablsdk").service("watcher",function(n,t,e){var r,a,u
...
default:return r()}}()}),angular.module("ablsdk",[]),angular.module("ablsdk").service("ablcalc",function(n,t){var e
return e=function(n){switch(!1){case"undefined"!=typeof n:return 0
case null!==typeof n:return 0
case 0!==n.length:return 0
default:return n.reduce(function(n,t){return n+t})}},function(r){var a,u,o,i,c,l,s,d,f,m,v,p,h,y
