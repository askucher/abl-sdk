...
return"unknown"},{name:t()}}),angular.module("ablsdk").service("ablapi",function(n){return{timeslots:function(t){var e
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}})
var toString$={}.toString
...
default:return"undefined"!=typeof console&&null!==console&&null!=(e=console.log)?e.apply(console,arguments):void 0}}}),angular.module("ablsdk").service("abldate",function(n){return function(t){var e,r
...
return e("Youth",null!=n&&null!=(t=n.timeslots)?t[0]:void 0)}}}),angular.module("ablsdk").service("ablcalc",function(n,t){var e
...
return e=n.$$phase,"$apply"===e||"$digest"===e?t():n.$apply(t)}}),angular.module("ablsdk").service("watcher",function(n,t,e){var r,a,o
