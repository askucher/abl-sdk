...
return available=slot.available+1-eval([0].concat(state.model.attendees.map(function(t){return t.quantity})).join("+")),debug({available:slot.available+1,taken:eval([0].concat(state.model.attendees.map(function(t){return t.quantity})).join("+")),result:available}),available}),performChooseSlot=function(t){var n,e,r,a,u
