...
default:return[]}}(),Array.prototype.push.apply(p,t),l.loading=!1},p.options={},p.urlOptions={},w=function(n){if(!l.loading){switch(toString$.call(n).slice(8,-1)){case"Number":p.options.page=n,e("number",p.options,n)
break
