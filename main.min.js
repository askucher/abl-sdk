...
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}}),angular.module("ablsdk").service("abldate",function(n){return function(t){var e,r
...
return u=moment(a).tz(t),n("timezone",t),r(u,u),e(u,moment(a)).toDate()}}}}),angular.module("ablsdk").service("ablcalc",function(n,t){var e
...
return e("Youth",null!=n&&null!=(t=n.timeslots)?t[0]:void 0)}}}),angular.module("ablsdk").service("p",function(){var n
...
default:return r()}}()}),angular.module("ablsdk").service("safeApply",function(n){return function(t){var e
return e=n.$$phase,"$apply"===e||"$digest"===e?t():n.$apply(t)}}),angular.module("ablsdk",[])
var toString$={}.toString
angular.module("ablsdk").service("crud",function(n,t,e,r,a,u){return function(o,i){var c,l,s,d,f,m,v,p,h,y,g,b,D,w,S,A,M,T
return c=o.split("@"),o=c[0],l={loading:!1},s={localStorage:{remove:function(n){},add:function(n){},update:function(n){},fetch:function(n){}},memory:{remove:function(n){return h(n)},add:function(n,t){return Array.prototype.push.call(p,n),"function"==typeof t?t(n):void 0},update:function(n,t){return"function"==typeof t?t(n):void 0},fetch:function(){return l.loading=!1}},backend:{remove:function(t){return n["delete"](o+"/"+t._id).success(function(){return h(t)})},update:function(t,e){return n.update(o+"/"+t._id,t).success(function(n){return l.loading=!1,"function"==typeof e?e(n):void 0})},add:function(t,r){return n.create(o,t).success(function(n){return e("backend-success",n),D(n),"function"==typeof r?r(n):void 0})},fetch:function(){return n.get(m(o),{params:p.options}).success(function(n,t,e){var r,a
return p.length=0,r=function(n){var t,r
