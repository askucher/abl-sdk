...
return a}),h},C(h),h}}),angular.module("ablsdk").service("browser",function(e){var n
...
return"unknown"},{name:n()}}),angular.module("ablsdk").service("ablfacade",function(e,n){return function(t,r){var a,o
...
default:return"undefined"!=typeof console&&null!==console&&null!=(t=console.log)?t.apply(console,arguments):void 0}}}),angular.module("ablsdk").filter("mdate",function(e){return function(e,n){return null!=e?e.format(n):null}}),angular.module("ablsdk").service("p",function(){var e
