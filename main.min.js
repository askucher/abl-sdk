...
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}})}.call(this),function(){angular.module("ablsdk").service("ablcalc",function(n){var t
...
return o=moment(n).tz(e),t("timezone",e),u(o,o),r(o,moment(n)).toDate()}}}})}.call(this),function(){var n={}.toString
...
default:return r()}}()})}.call(this),function(){angular.module("ablsdk").service("browser",function(n){var t
...
return"unknown"},{name:t()}})}.call(this),function(){angular.module("ablsdk",[])}.call(this),function(){angular.module("ablsdk").service("ablapi",function(n){return{timeslots:function(t){var e
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}})}.call(this),function(){angular.module("ablsdk").service("ablcalc",function(n){var t
return t=function(n){switch(!1){case"undefined"!=typeof n:return 0
case null!==typeof n:return 0
case 0!==n.length:return 0
...
t=n.navigator.userAgent,e={chrome:/chrome/i,safari:/safari/i,firefox:/firefox/i,ie:/msie/i}
for(r in e)if(e[r].test(n.navigator.userAgent))return r
return"unknown"},{name:t()}})}.call(this)
