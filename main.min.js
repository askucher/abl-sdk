...
return e}}function curry$(t,n){var e,r=function(a){return t.length>1?function(){var u=a?a.concat():[]
return e=n?e||this:this,u.push.apply(u,arguments)<t.length&&arguments.length?r.call(e,u):t.apply(e,u)}:t}
return r()}angular.module("ablsdk",[]),angular.module("ablsdk").service("ablapi",function(t){return{timeslots:function(n){var e
...
default:return t.reduce(function(t,n){return t+n})}},function(e){var r,a,u,o,i,c,l,s,f,d,m,p,v,y
...
return t=o(),n=function(){switch(!1){case!(y.codes[0].amountOff<t):return y.codes[0].amountOff
default:return t}},e=function(){switch(!1){case 0!==y.codes.length:return 0
case null==y.codes[0].amountOff:return n()
case null==y.codes[0].percentOff:return t/100*y.codes[0].percentOff
default:return 0}}()},v=function(){return o()+c()-p()},y={codes:[],calc:p,remove:function(t){var n
return n=y.codes.indexOf(t),n>-1?y.codes.splice(n,1):void 0},add:function(n){var e,r
if(0!==(null!=(e=y.code)?e:"").length)return y.error="",r=function(t){var e
return e=function(){return y.codes.push(t),y.code="",""},y.error=function(){switch(!1){case!(0!==t.maxRedemptions&&t.maxRedemptions<=t.redemptions):return"This coupon has been fully redeemed."
...
default:return e()}}()},t.get("coupon/"+y.code).success(function(t){return r(t)}).error(function(t){var n,e
return y.error=null!=(n=null!=t&&null!=(e=t.errors)?e[0]:void 0)?n:"Coupon not found"})},code:""},{coupon:y,addons:u.addons,attendees:u.attendees,totalWithoutTaxesfees:o,calcCoupon:p,calcTaxFee:i,calcTaxesFees:c,showPrice:l,calcPrice:s,showAddonPrice:f,calcAddonPrice:d,totalAddons:m,calcSubtotal:o,calcTotal:v}}}),angular.module("ablsdk").service("browser",function(t){var n
...
angular.module("ablsdk").service("crud",function(t,n,e,r,a,u){return function(o,i){var c,l,s,f,d,m,p,v,y,h,g,D,b,w,S,A,M,T
...
return t},p=n.$new(),p.items=[],v=p.items,l.loading=!1,y=function(t){var n
return n=v.indexOf(t),n>-1?Array.prototype.splice.call(v,n,1):void 0},h=function(t,n){return null!=t._id?g(t,n):D(t,n)},g=function(t,n){return l.loading?void 0:f.update(t,n)},D=function(t,n){return l.loading?void 0:f.add(t,n)},b=function(t){var n
...
return u=moment(a).tz(n),t("timezone",n),r(u,u),e(u,moment(a)).toDate()}}}}),angular.module("ablsdk").filter("mdate",function(t){return function(t,n){return null!=t?t.format(n):null}})
var toString$={}.toString
...
default:return r()}}()}),angular.module("ablsdk").service("formula",function(t,n){var e,r
...
return!1}),notAny:curry$(function(t,n){var e,r,a
for(e=0,r=n.length;r>e;++e)if(a=n[e],t(a))return!1
return!0}),sort:function(t){return t.concat().sort(function(t,n){return t>n?1:n>t?-1:0})},sortWith:curry$(function(t,n){return n.concat().sort(t)}),sortBy:curry$(function(t,n){return n.concat().sort(function(n,e){return t(n)>t(e)?1:t(n)<t(e)?-1:0})}),reverse:function(t){return t.concat().reverse()}}})
