...
return"unknown"},{name:n()}}),angular.module("ablsdk").service("ablcalc",function(t,n){var e
return e=function(t){switch(!1){case"undefined"!=typeof t:return 0
case null!==typeof t:return 0
case 0!==t.length:return 0
default:return t.reduce(function(t,n){return t+n})}},function(r){var a,u,o,i,c,l,s,d,f,m,p,v,y,h
return a=function(t){var n
return{name:t.name,quantity:null!=(n=t.count)?n:0,amount:t.amount,_id:t._id}},u=function(t,n){return n.amount-t.amount},o={attendees:null!=r?r.filter(function(t){return"aap"===t.type}).map(a).sort(u):void 0,addons:null!=r?r.filter(function(t){return"addon"===t.type}).map(a):void 0},i=function(){return e(o.attendees.map(d))+p()},c=function(t){switch(!1){case"tax"!==t.type:return i()/100*t.amount
...
return null!=(n=null!=(e=r.filter(function(n){return"aap"===n.type&&n.name===t.name}))&&null!=(a=e[0])?a.amount:void 0)?n:0},d=function(t){return s(t)*t.quantity},f=function(t){return e(o.addons.filter(function(n){return n.name===t.name}).map(function(t){return t.amount}))},m=function(t){return f(t)*t.quantity},p=function(){return e(o.addons.map(m))},v=function(){var t,n,e
...
default:return 0}}()},y=function(){return i()+l()-v()},h={codes:[],calc:v,remove:function(t){var n
...
return r=function(){return h.codes.push(t),h.code="",h.success="Coupon "+t.couponId+" added successfully",n(function(){var t
...
return h.error=null!=(n=null!=t&&null!=(e=t.errors)?e[0]:void 0)?n:"Coupon not found"})},code:""},{coupon:h,addons:o.addons,attendees:o.attendees,totalWithoutTaxesfees:i,calcCoupon:v,calcTaxFee:c,calcTaxesFees:l,showPrice:s,calcPrice:d,showAddonPrice:f,calcAddonPrice:m,totalAddons:p,calcSubtotal:i,calcTotal:y}}})
var toString$={}.toString
angular.module("ablsdk").service("crud",function(t,n,e,r,a,u){return function(o,i){var c,l,s,d,f,m,p,v,y,h,g,b,D,w,S,A,M,T
...
return n=e()[t],null!=n?(r=document.createElement("a"),r.href=e()[t],JSON.parse('{"'+decodeURI(r.search.substr(1,2e3)).replace(/"/g,'\\"').replace(/&/g,'","').replace(/=/g,'":"')+'"}')):void 0},v.options.total=(a=r("x-last-page-url"),null!=a?parseInt(a.page)*parseInt(a.pageSize):t.length),v.options.pageSize=(a=r("x-first-page-url"),null!=a?parseInt(a.pageSize):t.length),l.loading=!1,D(t)})}}},d=s[null!=(f=c[1])?f:"backend"],m=function(t){var n
for(n in v.urlOptions)t=t.replace(":"+n,v.urlOptions[n])
return t},p=n.$new(),p.items=[],v=p.items,l.loading=!1,y=function(t){var n
return n=v.indexOf(t),n>-1?Array.prototype.splice.call(v,n,1):void 0},h=function(t,n){return null!=t._id?g(t,n):b(t,n)},g=function(t,n){return l.loading?void 0:d.update(t,n)},b=function(t,n){return l.loading?void 0:d.add(t,n)},D=function(t){var n
...
break
case"Object":v.urlOptions=$.extend({},"function"==typeof t.$url?t.$url({},v.options.urlOptions):void 0),delete t.$url,v.options=$.extend({},t,v.options),v.page=1}return l.loading=!0,d.fetch()}},w(i),S=function(){var t
if(!l.loading)return t=Array.prototype.splice.apply(v,arguments),t.forEach(d.remove)},A=function(t,n,e){var a,u
if(!l.loading)return a={title:"Deletion",content:"Are you that you want to delete this item?",ok:"Confirm",cancel:"Cancel"},r.show(r.confirm().title(null!=(u=null!=e?e.title:void 0)?u:a.title).content(null!=(u=null!=e?e.content:void 0)?u:a.content).ok(null!=(u=null!=e?e.ok:void 0)?u:a.ok).cancel(null!=(u=null!=e?e.cancel:void 0)?u:a.cancel).targetEvent(n)).then(function(){return d.remove(t)},function(){})},M=[],T=function(t){var n,e
...
return e("Youth",null!=t&&null!=(n=t.timeslots)?n[0]:void 0)}}}),angular.module("ablsdk").filter("mdate",function(t){return function(t,n){return null!=t?t.format(n):null}}),angular.module("ablsdk").service("safeApply",function(t){return function(n){var e
return e=t.$$phase,"$apply"===e||"$digest"===e?n():t.$apply(n)}}),angular.module("ablsdk").service("p",function(){var t
...
return available=slot.available-eval([0].concat(state.model.calc.attendees.map(function(t){return t.quantity})).join("+"))}),performChooseSlot=function(t){var n,e,r,a,u
if(0!==t.available)return n=state.model.value,e=merge(n,t.startTime),state.model.date.start=e,r=abldate(activity.timeZone),state.model.date.origin=r.backendify(state.model.date.start).replace(/[\:-]/gi,""),state.model.date.end=t.endTime,state.model.charges=t.charges,state.model.calc=ablcalc(t.charges.concat(activity.charges)),state.model._id=t._id,state.model.eventId=activity.timeslots.filter(function(n){return n._id===t._id})[0].eventId,a=state.model.attendees,u=function(t){var n
...
default:return""}},notAvailableSlot=function(t){return t.available<=0},close=function(t){var n,e
return n=function(t){return 0===t.quantity&&"Adult"===t.name?t.quantity=1:void 0},e=state.model,e.attendees.forEach(n),e.chosen=t,e.visible=!1,e.closed(t),e},chooseSlot=function(t){return notAvailableSlot(t)?void 0:(performChooseSlot(t),close(!0))},isActiveDay=function(t){return getDay(t)===getDay(state.model.value)},isDisabledMonth=function(t){switch(!1){case!(getDay(t)<getDay(newDate())):return!0
default:return!1}},isActiveMonth=function(t){return getMonth(t)===getMonth(state.model.value)},isCalendarUpDisabled=function(){return getMonth(state.calendars[0].time)<getMonth(newDate())},calendarUp=function(){return isCalendarUpDisabled()?void 0:calendar.up()},calendarDown=function(){return calendar.down()},setup=function(){return setCalendars(generateCalendar(startMonth.clone()),generateCalendar(startMonth.clone().add(1,"month")),function(){return selectDay(state.model.value)})},createEventInstanceId=function(){var t
return t=abldate(activity.timeZone),state.model.eventId+"_"+t.backendify(state.model.date.start).replace(/[\:-]/gi,"")},y$=state,y$.setup=setup,y$.createEventInstanceId=createEventInstanceId,y$.startMonth=startMonth,y$.setCalendars=setCalendars,y$.selectDay=selectDay,y$.generateCalendar=generateCalendar,y$.calendarUp=calendarUp,y$.calendarDown=calendarDown,y$.close=close,y$.isActiveMonth=isActiveMonth,y$.isDisabledDay=isDisabledDay,y$.isDisabledMonth=isDisabledMonth,y$.isCalendarUpDisabled=isCalendarUpDisabled,y$.isDummy=isDummy,y$.isActiveDay=isActiveDay,y$.notSelected=notSelected,y$.chooseSlot=chooseSlot,y$.notAvailableSlot=notAvailableSlot,y$.disabledSlot=disabledSlot,setup(),state}}),angular.module("ablsdk",[]),angular.module("ablsdk").service("ablapi",function(t){return{timeslots:function(n){var e
return e=$.param({activity:n.activityId,dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),t.get("timeslots?"+e)}}}),angular.module("ablsdk").service("browser",function(t){var n
return n=function(){var n,e,r
n=t.navigator.userAgent,e={chrome:/chrome/i,safari:/safari/i,firefox:/firefox/i,ie:/msie/i}
for(r in e)if(e[r].test(t.navigator.userAgent))return r
