...
return function(){var n,e
for(e=t[0].apply(this,arguments),n=1;n<t.length;++n)e=t[n](e)
return e}}angular.module("ablsdk",[]),angular.module("ablsdk").service("ablcalc",function(t){var n
...
default:return r()}}()}),angular.module("ablsdk",[]),angular.module("ablsdk").service("ablcalc",function(t){var n
return n=function(t){switch(!1){case"undefined"!=typeof t:return 0
case null!==typeof t:return 0
case 0!==t.length:return 0
default:return t.reduce(function(t,n){return t+n})}},function(e){var r,a,u,o,i,c,l,s,f,d,m,p,v,y
