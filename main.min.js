...
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}})}.call(this),function(){function n(n,t){var e,r=function(u){return n.length>1?function(){var o=u?u.concat():[]
...
return u}),y},T(y),y}})}.call(this),function(){angular.module("ablsdk").service("ablcalc",function(n){var t
...
return o=moment(n).tz(e),t("timezone",e),u(o,o),r(o,moment(n)).toDate()}}}})}.call(this),function(){angular.module("ablsdk").service("browser",function(n){var t
...
return"unknown"},{name:t()}})}.call(this),function(){var n={}.toString
...
default:return"undefined"!=typeof console&&null!==console&&null!=(r=console.log)?r.apply(console,arguments):void 0}}})}.call(this),function(){angular.module("ablsdk").service("safeApply",function(n){return function(t){var e
return e=n.$$phase,"$apply"===e||"$digest"===e?t():n.$apply(t)}})}.call(this),function(){angular.module("ablsdk").service("watcher",function(n,t,e){var r,u,o
...
default:return r()}}()})}.call(this),function(){angular.module("ablsdk",[])}.call(this),function(){angular.module("ablsdk").service("ablapi",function(n){return{timeslots:function(t){var e
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}})}.call(this),function(){function n(n,t){var e,r=function(u){return n.length>1?function(){var o=u?u.concat():[]
return e=t?e||this:this,o.push.apply(o,arguments)<n.length&&arguments.length?r.call(e,o):n.apply(e,o)}:n}
return r()}var t={}.toString
angular.module("ablsdk").service("crud",function(e,r,u,o,a,c){return function(i,l){var f,s,d,p,m,h,v,y,g,w,b,O,k,A,x,S,Y,T
