...
return t}}function curry$(e,n){var t,r=function(a){return e.length>1?function(){var o=a?a.concat():[]
return t=n?t||this:this,o.push.apply(o,arguments)<e.length&&arguments.length?r.call(t,o):e.apply(t,o)}:e}
return r()}angular.module("ablsdk",[]),angular.module("ablsdk").service("ablbook",function(e,n,t,r,a,o){return function(r,o){var u,i,c,l,s,d,f,m,p,v,h,y,g,b,D,w,$,x,S,k,C,A,M,T,I
...
return u.typingInput===n&&null!=(null!=(i=e[n])&&null!=(c=i.$error)?c.pattern:void 0)&&(null!=(l=C[n].example)?l.length:void 0)>0?"example: "+C[n].example:void 0},T=function(e){return u.typingInput===e?C[e].example:C[e].placeholder},a(function(){var e,n
return e=u.form,e.email="test@debug.com",e.name="Test User",e.phone="+380665243646",e.address="664 Cypress Lane, Campbell, CA, United States",e.notes="Some test notes",n=u.form.creditCard,n.card="5105 1051 0510 5100",n.expDate="05/17",n.cvv="333",u.form.agreed=!0}),I=u,I.investigateDate=c,I.placeholder=T,I.closeError=d,I.checkout=$,I.agree=x,I.fields=C,I.few=p,I.expDateChanged=g,I.cardChanged=b,I.disabledOrder=h,I.typing=f,I.message=M,u}}),angular.module("ablsdk").service("ablcalc",function(e,n){var t
...
return"unknown"},{name:n()}}),angular.module("ablsdk").service("ablapi",function(e){return{timeslots:function(n){var t
return t=$.param({activity:n.activityId,"status[event]":"all",dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),e.get("timeslots?"+t)}}}),angular.module("app").service("ablfacade",function(e,n){return function(t,r){var a,o
return a=e(t,r),o=n(t,a.calendar),{book:a,slot:o}}}),angular.module("ablsdk").service("abldate",function(e){return function(n){var t,r
...
return o=moment(a).tz(n),e("timezone",n),r(o,o),t(o,moment(a)).toDate()}}}}),angular.module("ablsdk").service("formula",function(e,n){var t,r
...
return t("Youth",null!=e&&null!=(n=e.timeslots)?n[0]:void 0)}}})
...
return a}),h},C(h),h}}),angular.module("ablsdk").factory("prefill",function(e,n,t){return function(r){return e(function(){return t.prefill=function(){var e
return e=arguments,n(function(){return r.apply(null,e)})},null!=t.parent?t.parent.prefill=t.prefill:void 0})}})
var toString$={}.toString
...
default:return r()}}()}),angular.module("ablsdk").factory("stripe",function(e,n){var t,r
...
return r(),t}),angular.module("ablsdk").service("p",function(){var e
...
return n},sort:function(e){return e.concat().sort(function(e,n){return e>n?1:n>e?-1:0})},sortWith:curry$(function(e,n){return n.concat().sort(e)}),sortBy:curry$(function(e,n){return n.concat().sort(function(n,t){return e(n)>e(t)?1:e(n)<e(t)?-1:0})}),reverse:function(e){return e.concat().reverse()}}}),angular.module("ablsdk",[]),angular.module("ablsdk").service("ablbook",function(e,n,t,r,a,o){return function(r,o){var u,i,c,l,s,d,f,m,p,v,h,y,g,b,D,w,$,x,S,k,C,A,M,T,I
return u={triedCheckout:!1,typing:"",braintreeClient:null,loading:!1,idenpotencyKey:null,form:{error:"",agreed:!1,email:"",name:"",phone:"",address:"",location:{},notes:"",date:{start:null,end:null},creditCard:{card:"",expDate:"",cvv:""}},calendar:{value:null,visible:!1,currentActivity:r,closed:function(e){return u.form.date.start=u.calendar.date.start,u.form.date.end=u.calendar.date.end,o("slot-chosen",e)}}},i=function(e){var n
return null!=e?(n=null!=(null!=e?e.format:void 0)?e:moment(e),parseInt(n.format("YYYYMMDD"))):null},c=function(e){var n
return n=function(){switch(!1){case null!==e.start:return"none"
case i(e.start)===i(e.end):return"different"
...
return!0}),sum:function(e){var n,t,r,a
for(n=0,t=0,r=e.length;r>t;++t)a=e[t],n+=a
return n},sort:function(e){return e.concat().sort(function(e,n){return e>n?1:n>e?-1:0})},sortWith:curry$(function(e,n){return n.concat().sort(e)}),sortBy:curry$(function(e,n){return n.concat().sort(function(n,t){return e(n)>e(t)?1:e(n)<e(t)?-1:0})}),reverse:function(e){return e.concat().reverse()}}})
