...
return state.model.chosen=t,state.model.visible=!1,n=function(t){return 0===t.quantity&&"Adult"===t.name?t.quantity=1:void 0},state.model.attendees.forEach(n)},chooseSlot=function(t){return notAvailableSlot(t)?void 0:(performChooseSlot(t),close(!0))},isActiveDay=function(t){return getDay(t)===getDay(state.model.value)},isDisabledMonth=function(t){switch(!1){case!(getDay(t)<getDay(newDate())):return!0
