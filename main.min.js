...
return h.error=null!=(n=null!=t&&null!=(e=t.errors)?e[0]:void 0)?n:"Coupon not found"})},code:""},{coupon:h,addons:o.addons,attendees:o.attendees,totalWithoutTaxesfees:i,calcCoupon:p,calcTaxFee:c,calcTaxesFees:l,showPrice:s,calcPrice:d,showAddonPrice:f,calcAddonPrice:m,totalAddons:v,calcSubtotal:i,calcTotal:y}}})
var toString$={}.toString
angular.module("ablsdk").service("crud",function(t,n,e,r,a,u){return function(o,i){var c,l,s,d,f,m,v,p,y,h,g,b,D,w,S,A,M,T
...
return n=e()[t],null!=n?(r=document.createElement("a"),r.href=e()[t],JSON.parse('{"'+decodeURI(r.search.substr(1,2e3)).replace(/"/g,'\\"').replace(/&/g,'","').replace(/=/g,'":"')+'"}')):void 0},p.options.total=(a=r("x-last-page-url"),null!=a?parseInt(a.page)*parseInt(a.pageSize):t.length),p.options.pageSize=(a=r("x-first-page-url"),null!=a?parseInt(a.pageSize):t.length),l.loading=!1,D(t)})}}},d=s[null!=(f=c[1])?f:"backend"],m=function(t){var n
for(n in p.urlOptions)t=t.replace(":"+n,p.urlOptions[n])
return t},v=n.$new(),v.items=[],p=v.items,l.loading=!1,y=function(t){var n
return n=p.indexOf(t),n>-1?Array.prototype.splice.call(p,n,1):void 0},h=function(t,n){return null!=t._id?g(t,n):b(t,n)},g=function(t,n){return l.loading?void 0:d.update(t,n)},b=function(t,n){return l.loading?void 0:d.add(t,n)},D=function(t){var n
...
break
case"Object":p.urlOptions=$.extend({},"function"==typeof t.$url?t.$url({},p.options.urlOptions):void 0),delete t.$url,p.options=$.extend({},t,p.options),p.page=1}return l.loading=!0,d.fetch()}},w(i),S=function(){var t
if(!l.loading)return t=Array.prototype.splice.apply(p,arguments),t.forEach(d.remove)},A=function(t,n,e){var a,u
