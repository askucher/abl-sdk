...
return e=$.param({activity:n.activityId,dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),t.get("timeslots?"+e)}}}),angular.module("ablsdk").service("ablcalc",function(t,n){var e
...
return e("Youth",null!=t&&null!=(n=t.timeslots)?n[0]:void 0)}}}),angular.module("ablsdk").service("abldate",function(t){return function(n){var e,r
...
return u=moment(a).tz(n),t("timezone",n),r(u,u),e(u,moment(a)).toDate()}}}}),angular.module("ablsdk").filter("mdate",function(t){return function(t,n){return null!=t?t.format(n):null}}),angular.module("ablsdk").service("safeApply",function(t){return function(n){var e
