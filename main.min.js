...
return function(){var n,e
for(e=t[0].apply(this,arguments),n=1;n<t.length;++n)e=t[n](e)
return e}}angular.module("ablsdk",[]),angular.module("ablsdk").service("browser",function(t){var n
...
angular.module("ablsdk").service("crud",function(t,n,e,r,a,u){return function(o,i){var c,l,s,f,d,m,p,v,h,y,g,D,b,w,S,A,M,T
...
return a}),v},T(v),v}}),angular.module("ablsdk").service("ablcalc",function(t){var n
...
return h.error=null!=(n=null!=t&&null!=(e=t.errors)?e[0]:void 0)?n:"Coupon not found"})},code:""},{coupon:h,addons:u.addons,attendees:u.attendees,totalWithoutTaxesfees:o,calcCoupon:p,calcTaxFee:i,calcTaxesFees:c,showPrice:l,calcPrice:s,showAddonPrice:f,calcAddonPrice:d,totalAddons:m,calcSubtotal:o,calcTotal:v}}}),angular.module("ablsdk").service("ablapi",function(t){return{timeslots:function(n){var e
return e=$.param({activity:n.activityId,dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),t.get("timeslots?"+e)}}})
var toString$={}.toString
...
default:return"undefined"!=typeof console&&null!==console&&null!=(e=console.log)?e.apply(console,arguments):void 0}}}),angular.module("ablsdk").service("abldate",function(t){return function(n){var e,r
...
return u=moment(a).tz(n),t("timezone",n),r(u,u),e(u,moment(a)).toDate()}}}}),angular.module("ablsdk").service("p",function(){var t
...
default:return r()}}()}),angular.module("ablsdk").service("ablslot",function(abldate,ablcalc,ablapi,formula,p){return function(activity){var transformCharge,state,ref$,getDay,newDate,generateCalendar,getMonth,hackDate,merge,makeAvailable,performChooseSlot,actualEvent,isEmpty,slotsByDay,select,isFitToSlot,isNotFitToAnySlot,inPast,createMonth,startMonth,setCalendars,scroll,nextMonth,calendar,loadEvents,isDummy,isDisabledDay,selectDay,notSelected,disabledSlot,notAvailableSlot,close,chooseSlot,isActiveDay,isDisabledMonth,isActiveMonth,isCalendarUpDisabled,calendarUp,calendarDown,x$
return transformCharge=function(t){return{_id:t._id,name:t.name,quantity:0,amount:t.amount}},state={slots:[],model:{date:{start:null,end:null},visible:!1,value:null,eventId:null,charges:[],attendees:[],addons:activity.charges.filter(function(t){return"addon"===t.type}).map(transformCharge),questions:null!=(ref$=activity.questions)?ref$:[],bg:activity.image},calendars:[],activeSlots:[]},getDay=function(t){var n
