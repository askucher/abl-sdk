...
// Generated by LiveScript 1.3.1
// Generated by LiveScript 1.3.1
function curry$(n,t){var e,r=function(a){return n.length>1?function(){var o=a?a.concat():[]
...
return e}}function curry$(n,t){var e,r=function(a){return n.length>1?function(){var o=a?a.concat():[]
return e=t?e||this:this,o.push.apply(o,arguments)<n.length&&arguments.length?r.call(e,o):n.apply(e,o)}:n}
return r()}function bind$(n,t,e){return function(){return(e||n)[t].apply(n,arguments)}}function curry$(n,t){var e,r=function(a){return n.length>1?function(){var o=a?a.concat():[]
return e=t?e||this:this,o.push.apply(o,arguments)<n.length&&arguments.length?r.call(e,o):n.apply(e,o)}:n}
return r()}function bind$(n,t,e){return function(){return(e||n)[t].apply(n,arguments)}}function curry$(n,t){var e,r=function(a){return n.length>1?function(){var o=a?a.concat():[]
...
default:return n.reduce(function(n,t){return n+t})}},function(r){var a,o,u,i,c,l,s,d,f,m,p,v,h,y
...
default:return 0}}()},h=function(){return i()+l()-v()},y={codes:[],calc:v,remove:function(n){var t
...
return n},p=t.$new(),p.items=[],v=p.items,l.loading=!1,h=function(n){var t
return t=v.indexOf(n),t>-1?Array.prototype.splice.call(v,t,1):void 0},y=function(n,t){return null!=n._id?g(n,t):b(n,t)},g=function(n,t){return l.loading?void 0:d.update(n,t)},b=function(n,t){return l.loading?void 0:d.add(n,t)},D=function(n){var t
...
default:return[]}}(),Array.prototype.push.apply(v,t),l.loading=!1},v.options={},v.urlOptions={},w=function(n){if(!l.loading){switch(toString$.call(n).slice(8,-1)){case"Number":v.options.page=n,e("number",v.options,n)
break
case"Object":v.urlOptions=$.extend({},"function"==typeof n.$url?n.$url({},v.options.urlOptions):void 0),delete n.$url,v.options=$.extend({},n,v.options)}return l.loading=!0,null!=v.options.page&&(1===v.options.page?delete v.options.page:v.options.page-=1),e("final-options",v.options,n),d.fetch()}},w(i),S=function(){var n
if(!l.loading)return n=Array.prototype.splice.apply(v,arguments),n.forEach(d.remove)},A=function(n,t,e){var a,o
...
return o}),fold:curry$(function(n,t,e){var r,a,o
for(r=0,a=e.length;a>r;++r)o=e[r],t=n(t,o)
return t}),filter:curry$(function(n,t){var e,r,a,o=[]
...
return available=slot.available-eval([0].concat(model.calc.attendees.map(function(n){return n.quantity})).join("+"))}),performChooseSlot=function(n){var t,e,r,a,o,u,i
if(0!==n.available)return t=model.value,e=merge(t,n.startTime),model.date.start=e,r=abldate(activity.timeZone),model.date.origin=r.backendify(model.date.start).replace(/[\:-]/gi,""),model.date.end=n.endTime,model.charges=n.charges,model.calc=ablcalc(n.charges.concat(activity.charges)),model._id=n._id,model.eventId=null!=(a=activity.timeslots.filter(function(t){return t._id===n._id}))&&null!=(o=a[0])?o.eventId:void 0,u=model.attendees,i=function(n){var t
