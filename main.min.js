...
return e=null!=t?t:hackDate(t,moment()),r=null!=n?n:hackDate(n,moment()),moment([e.year(),e.month(),e.date(),r.hours(),r.minutes(),0])},makeAvailable=curry$(function(slot,arg){return debug("make-available",slot.available,state.model.attendees.map(function(t){return t.quantity})),slot.available-eval([0].concat(state.model.attendees.map(function(t){return t.quantity})).join("+"))}),performChooseSlot=function(t){var n,e,r,a,u
