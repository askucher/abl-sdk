...
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}}),angular.module("ablsdk").service("ablcalc",function(n,t){var e
...
return a}),v},T(v),v}}),angular.module("ablsdk").service("browser",function(n){var t
...
return o=moment(a).tz(t),n("timezone",t),r(o,o),e(o,moment(a)).toDate()}}}}),angular.module("ablsdk").service("formula",function(n,t){var e,r
...
return n=arguments,t(function(){return r.apply(null,n)})}})}})
var toString$={}.toString
