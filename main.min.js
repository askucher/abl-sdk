...
// Generated by LiveScript 1.3.1
// Generated by LiveScript 1.3.1
(function(){angular.module("ablsdk",[])}).call(this),function(){angular.module("ablsdk").service("ablcalc",function(n){var t
...
return"unknown"},{name:t()}})}.call(this),function(){angular.module("ablsdk").service("ablapi",function(n){return{timeslots:function(t){var e
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}})}.call(this),function(){var n={}.toString
...
default:return"undefined"!=typeof console&&null!==console&&null!=(r=console.log)?r.apply(console,arguments):void 0}}})}.call(this),function(){function n(n,t){var e,r=function(u){return n.length>1?function(){var o=u?u.concat():[]
...
return o=moment(n).tz(e),t("timezone",e),u(o,o),r(o,moment(n)).toDate()}}}})}.call(this),function(){angular.module("ablsdk").service("watcher",function(n,t,e){var r,u,o
...
return e=n.$$phase,"$apply"===e||"$digest"===e?t():n.$apply(t)}})}.call(this),function(){angular.module("ablsdk",[])}.call(this),function(){angular.module("ablsdk").service("ablcalc",function(n){var t
return t=function(n){switch(!1){case"undefined"!=typeof n:return 0
case null!==typeof n:return 0
case 0!==n.length:return 0
default:return n.reduce(function(n,t){return n+t})}},function(e){var r,u,o,a,c,i,l,f,s,d,p,m,h,v
