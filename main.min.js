...
return function(){var n,e
for(e=t[0].apply(this,arguments),n=1;n<t.length;++n)e=t[n](e)
return e}}angular.module("ablsdk",[]),angular.module("ablsdk").service("ablcalc",function(t,n){var e
...
return h.error=null!=(n=null!=t&&null!=(e=t.errors)?e[0]:void 0)?n:"Coupon not found"})},code:""},{coupon:h,addons:o.addons,attendees:o.attendees,totalWithoutTaxesfees:i,calcCoupon:v,calcTaxFee:c,calcTaxesFees:l,showPrice:s,calcPrice:d,showAddonPrice:f,calcAddonPrice:m,totalAddons:p,calcSubtotal:i,calcTotal:y}}}),angular.module("ablsdk").service("ablapi",function(t){return{timeslots:function(n){var e
...
default:return"undefined"!=typeof console&&null!==console&&null!=(e=console.log)?e.apply(console,arguments):void 0}}}),angular.module("ablsdk").filter("mdate",function(t){return function(t,n){return null!=t?t.format(n):null}}),angular.module("ablsdk").service("formula",function(t,n){var e,r
...
return e("Youth",null!=t&&null!=(n=t.timeslots)?n[0]:void 0)}}}),angular.module("ablsdk").service("browser",function(t){var n
...
return"unknown"},{name:n()}}),angular.module("ablsdk").service("p",function(){var t
...
default:return r()}}()}),angular.module("ablsdk",[]),angular.module("ablsdk").service("ablcalc",function(t,n){var e
return e=function(t){switch(!1){case"undefined"!=typeof t:return 0
case null!==typeof t:return 0
case 0!==t.length:return 0
default:return t.reduce(function(t,n){return t+n})}},function(r){var a,u,o,i,c,l,s,d,f,m,p,v,y,h
