...
return e}}function curry$(t,n){var e,r=function(a){return t.length>1?function(){var u=a?a.concat():[]
return e=n?e||this:this,u.push.apply(u,arguments)<t.length&&arguments.length?r.call(e,u):t.apply(e,u)}:t}
return r()}angular.module("ablsdk").service("ablcalc",function(t,n){var e
return e=function(t){switch(!1){case"undefined"!=typeof t:return 0
case null!==typeof t:return 0
case 0!==t.length:return 0
default:return t.reduce(function(t,n){return t+n})}},function(r){var a,u,o,i,c,l,s,f,d,m,p,v,y,h
return a=function(t){var n
return{name:t.name,quantity:null!=(n=t.count)?n:0,amount:t.amount,_id:t._id}},u=function(t,n){return n.amount-t.amount},o={attendees:null!=r?r.filter(function(t){return"aap"===t.type}).map(a).sort(u):void 0,addons:null!=r?r.filter(function(t){return"addon"===t.type}).map(a):void 0},i=function(){return e(o.attendees.map(f))+p()},c=function(t){switch(!1){case"tax"!==t.type:return i()/100*t.amount
...
angular.module("ablsdk").service("crud",function(t,n,e,r,a,u){return function(o,i){var c,l,s,f,d,m,p,v,y,h,g,b,D,w,S,A,M,T
...
return n=e()[t],null!=n?(r=document.createElement("a"),r.href=e()[t],JSON.parse('{"'+decodeURI(r.search.substr(1,2e3)).replace(/"/g,'\\"').replace(/&/g,'","').replace(/=/g,'":"')+'"}')):void 0},v.options.total=(a=r("x-last-page-url"),null!=a?parseInt(a.page)*parseInt(a.pageSize):t.length),v.options.pageSize=(a=r("x-first-page-url"),null!=a?parseInt(a.pageSize):t.length),l.loading=!1,D(t)})}}},f=s[null!=(d=c[1])?d:"backend"],m=function(t){var n
for(n in v.urlOptions)t=t.replace(":"+n,v.urlOptions[n])
return t},p=n.$new(),p.items=[],v=p.items,l.loading=!1,y=function(t){var n
return n=v.indexOf(t),n>-1?Array.prototype.splice.call(v,n,1):void 0},h=function(t,n){return null!=t._id?g(t,n):b(t,n)},g=function(t,n){return l.loading?void 0:f.update(t,n)},b=function(t,n){return l.loading?void 0:f.add(t,n)},D=function(t){var n
...
return a}),v},T(v),v}}),angular.module("ablsdk").service("formula",function(t,n){var e,r
...
return e("Youth",null!=t&&null!=(n=t.timeslots)?n[0]:void 0)}}}),angular.module("ablsdk").service("ablslot",function(abldate,ablcalc,ablapi,formula,p,debug){return function(activity,model){var transformCharge,state,x$,ref$,getDay,newDate,generateCalendar,getMonth,hackDate,merge,makeAvailable,performChooseSlot,actualEvent,isEmpty,slotsByDay,select,isFitToSlot,isNotFitToAnySlot,inPast,createMonth,startMonth,setCalendars,scroll,nextMonth,calendar,loadEvents,isDummy,isDisabledDay,selectDay,notSelected,disabledSlot,notAvailableSlot,close,chooseSlot,isActiveDay,isDisabledMonth,isActiveMonth,isCalendarUpDisabled,calendarUp,calendarDown,y$
...
default:return r()}}()}),angular.module("ablsdk").service("p",function(){var t
