...
return e}}function curry$(n,t){var e,r=function(a){return n.length>1?function(){var u=a?a.concat():[]
return e=t?e||this:this,u.push.apply(u,arguments)<n.length&&arguments.length?r.call(e,u):n.apply(e,u)}:n}
return r()}angular.module("ablsdk").service("ablapi",function(n){return{timeslots:function(t){var e
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}}),angular.module("ablsdk",[]),angular.module("ablsdk").service("browser",function(n){var t
...
case"Array"!==toString$.call(n[o]).slice(8,-1):return n[o]
case"Object"!==toString$.call(n).slice(8,-1):return[n]
default:return[]}}(),Array.prototype.push.apply(p,t),l.loading=!1},p.options={},p.urlOptions={},w=function(n){if(e("fetch",l.loading),!l.loading){switch(typeof n){case"Number":p.options.page=n
break
case"Object":p.urlOptions=$.extend({},"function"==typeof n.$url?n.$url({},p.options.urlOptions):void 0),delete n.$url,p.options=$.extend({},n,p.options),p.page=1}return l.loading=!0,d.fetch()}},w(i),S=function(){var n
if(!l.loading)return n=Array.prototype.splice.apply(p,arguments),n.forEach(d.remove)},A=function(n,t,e){var a,u
if(!l.loading)return a={title:"Deletion",content:"Are you that you want to delete this item?",ok:"Confirm",cancel:"Cancel"},r.show(r.confirm().title(null!=(u=null!=e?e.title:void 0)?u:a.title).content(null!=(u=null!=e?e.content:void 0)?u:a.content).ok(null!=(u=null!=e?e.ok:void 0)?u:a.ok).cancel(null!=(u=null!=e?e.cancel:void 0)?u:a.cancel).targetEvent(t)).then(function(){return d.remove(n)},function(){})},M=[],T=function(n){var t,e
return t=[],e=curry$(function(e,r){var a,u
return a=[],T(a),u=function(){var t
...
return t=[],Array.prototype.push.apply(t,n),t},n.watch=function(e,r){var o
return o=function(){return a(function(){return t.forEach(function(n){return n()})})},null!=r?(M.push({array:r[e],func:o}),r.$watch(e,o,!0)):(M.push({array:e,func:o}),u.watch(e,o)),n},n.watch(n),["map","filter"].forEach(function(t){return n[t]=e(t)}),n.push=b,n.save=y,n.fetch=w,n.remove=A,n.splice=S,n.toArray=function(){return angular.copy(n)}},p.listen=function(n){return n.$on("$destroy",function(){var n,t,e,r,a=[]
for(n=0,e=(t=M).length;e>n;++n)r=t[n],a.push(u.unwatch(r.array,r.func))
return a}),p},T(p),p}}),angular.module("ablsdk").service("ablcalc",function(n,t){var e
return e=function(n){switch(!1){case"undefined"!=typeof n:return 0
case null!==typeof n:return 0
case 0!==n.length:return 0
default:return n.reduce(function(n,t){return n+t})}},function(r){var a,u,o,i,c,l,s,d,f,m,v,p,h,y
return a=function(n){var t
return{name:n.name,quantity:null!=(t=n.count)?t:0,amount:n.amount,_id:n._id}},u=function(n,t){return t.amount-n.amount},o={attendees:null!=r?r.filter(function(n){return"aap"===n.type}).map(a).sort(u):void 0,addons:null!=r?r.filter(function(n){return"addon"===n.type}).map(a):void 0},i=function(){return e(o.attendees.map(d))+v()},c=function(n){switch(!1){case"tax"!==n.type:return i()/100*n.amount
case"fee"!==n.type:return e(o.attendees.map(function(n){return n.quantity}))*n.amount
default:return 0}},l=function(){return e(r.map(c))},s=function(n){var t,e,a
return null!=(t=null!=(e=r.filter(function(t){return"aap"===t.type&&t.name===n.name}))&&null!=(a=e[0])?a.amount:void 0)?t:0},d=function(n){return s(n)*n.quantity},f=function(n){return e(o.addons.filter(function(t){return t.name===n.name}).map(function(n){return n.amount}))},m=function(n){return f(n)*n.quantity},v=function(){return e(o.addons.map(m))},p=function(){var n,t,e
...
return y.error=null!=(t=null!=n&&null!=(e=n.errors)?e[0]:void 0)?t:"Coupon not found"})},code:""},{coupon:y,addons:o.addons,attendees:o.attendees,totalWithoutTaxesfees:i,calcCoupon:p,calcTaxFee:c,calcTaxesFees:l,showPrice:s,calcPrice:d,showAddonPrice:f,calcAddonPrice:m,totalAddons:v,calcSubtotal:i,calcTotal:h}}}),angular.module("ablsdk").service("abldate",function(n){return function(t){var e,r
return e=function(n,t){var e,r
return e=bind$(moment(n),"format"),r=bind$(t,"format"),moment(e("YYYY-MM-DD HH:mm ")+r("Z"),"YYYY-MM-DD HH:mm Z")},r=function(n,e){return n.add(moment(e).tz(t).utcOffset()-n.utcOffset(),"minute")},{backendify:function(a){var u
return u=e(a,moment().tz(t)).tz(t),n("timezone",t),r(u),u.tz("UTC").format("YYYY-MM-DD\\THH:mm:ss\\Z")},frontendify:function(a){var u
return u=moment(a).tz(t),n("timezone",t),r(u,u),e(u,moment(a)).toDate()}}}})
var toString$={}.toString
...
return n.map(function(n){return n.amount})(null!=(e=null!=t?t.charges:void 0)?e:[])},o=r(t.timeslots.map(a)),i=r(t.timeslots.map(u)),c=function(n){return Math.max.apply(Math,n)},l=function(){switch(!1){case!(o.length>0):return c(o)
...
return available=slot.available-eval([0].concat(model.calc.attendees.map(function(n){return n.quantity})).join("+"))}),performChooseSlot=function(n){var t,e,r,a,u
if(0!==n.available)return t=model.value,e=merge(t,n.startTime),model.date.start=e,r=abldate(activity.timeZone),model.date.origin=r.backendify(model.date.start).replace(/[\:-]/gi,""),model.date.end=n.endTime,model.charges=n.charges,model.calc=ablcalc(n.charges.concat(activity.charges)),model._id=n._id,model.eventId=activity.timeslots.filter(function(t){return t._id===n._id})[0].eventId,a=model.attendees,u=function(n){var t
...
return t=n.$new(),function(n,e){return t.array=n,t.$watch("array",e)}},(a=null!=(u=Array.observe)?u:r())(t,e)}}},e(t.name),u=function(){switch(!1){case"firefox"!==t.name:return r()
case"unknown"!==t.name:return r()
case"safari"!==t.name:return r()
default:return r()}}()}),angular.module("ablsdk").service("ablapi",function(n){return{timeslots:function(t){var e
return e=$.param({activity:t.activityId,dateRange:[moment(t.startTime).clone().startOf("day").startOf("month").toISOString(),moment(t.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),n.get("timeslots?"+e)}}}),angular.module("ablsdk",[]),angular.module("ablsdk").service("browser",function(n){var t
return t=function(){var t,e,r
t=n.navigator.userAgent,e={chrome:/chrome/i,safari:/safari/i,firefox:/firefox/i,ie:/msie/i}
for(r in e)if(e[r].test(n.navigator.userAgent))return r
