...
// Generated by LiveScript 1.3.1
// Generated by LiveScript 1.3.1
function bind$(e,n,t){return function(){return(t||e)[n].apply(e,arguments)}}function curry$(e,n){var t,r=function(a){return e.length>1?function(){var o=a?a.concat():[]
...
return t}}function bind$(e,n,t){return function(){return(t||e)[n].apply(e,arguments)}}function curry$(e,n){var t,r=function(a){return e.length>1?function(){var o=a?a.concat():[]
return t=n?t||this:this,o.push.apply(o,arguments)<e.length&&arguments.length?r.call(t,o):e.apply(t,o)}:e}
return r()}function bind$(e,n,t){return function(){return(t||e)[n].apply(e,arguments)}}function curry$(e,n){var t,r=function(a){return e.length>1?function(){var o=a?a.concat():[]
return t=n?t||this:this,o.push.apply(o,arguments)<e.length&&arguments.length?r.call(t,o):e.apply(t,o)}:e}
return r()}function bind$(e,n,t){return function(){return(t||e)[n].apply(e,arguments)}}function curry$(e,n){var t,r=function(a){return e.length>1?function(){var o=a?a.concat():[]
...
return function(){var n,t
for(t=e[0].apply(this,arguments),n=1;n<e.length;++n)t=e[n](t)
return t}}angular.module("ablsdk",[]),angular.module("ablsdk").service("ablcalc",function(e,n){var t
return t=function(e){switch(!1){case"undefined"!=typeof e:return 0
case null!==typeof e:return 0
case 0!==e.length:return 0
default:return e.reduce(function(e,n){return e+n})}},function(r){var a,o,u,i,c,l,s,d,f,m,p,v,h,y,g,b,D
...
return e=c(),n=function(){switch(!1){case!(D.codes[0].amountOff<e):return D.codes[0].amountOff
default:return e}},t=function(){switch(!1){case 0!==D.codes.length:return 0
case null==D.codes[0].amountOff:return n()
case null==D.codes[0].percentOff:return e/100*D.codes[0].percentOff
default:return 0}}()},y=function(){return c()+s()-h()},g=function(){return y()},b=function(){return 64},D={codes:[],calc:h,remove:function(e){var n
return n=D.codes.indexOf(e),n>-1?D.codes.splice(n,1):void 0},add:function(t){var r,a
if(0!==(null!=(r=D.code)?r:"").length&&(D.code=D.code.toUpperCase(),D.error=function(){switch(!1){case 0!==D.code.length:return"Code is required"
case!(D.code.length<6):return"6 chars are required"
default:return""}}(),!(D.error.length>0)))return a=function(e){var r
return r=function(){return D.codes.push(e),D.code="",D.success="Coupon "+e.couponId+" added successfully",n(function(){var e
return e=D.success,delete D.success,e},3e3),""},D.error=function(){switch(!1){case!(0!==e.maxRedemptions&&e.maxRedemptions<=e.redemptions):return"This coupon has been fully redeemed."
...
default:return r()}}()},e.get("coupon/"+D.code).success(function(e){return a(e)}).error(function(e){var n,t
return D.error=null!=(n=null!=e&&null!=(t=e.errors)?t[0]:void 0)?n:"Coupon not found"})},code:""},{coupon:D,addons:i.addons,attendees:i.attendees,totalWithoutTaxesfees:c,calcCoupon:h,calcTaxFee:l,calcTaxesFees:s,showPrice:d,calcPrice:f,showAddonPrice:m,calcAddonPrice:p,totalAddons:v,calcSubtotal:c,calcTotal:y,calcPreviousTotal:g,calcBalanceDue:b}}}),angular.module("ablsdk").service("ablapi",function(e){return{timeslots:function(n){var t
return t=$.param({activity:n.activityId,"status[event]":"all",dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),e.get("timeslots?"+t)}}}),angular.module("ablsdk").service("ablbook",function(e,n,t,r,a,o){return function(r,o){var u,i,c,l,s,d,f,m,p,v,h,y,g,b,D,w,$,x,S,k,C,A,T,M,I
...
return s(null!=(n=null!=(t=e.errors)?t[0]:void 0)?n:"Server error")})["finally"](function(){return u.loading=!1}))}))},w=function(){return e.get("payments/setup")},$=function(e){return u.loading!==!0?(u.triedCheckout=!0,l(e)?(u.loading=!0,w().success(function(e){return D(e.publicKey,function(){return o("success",e)})}).error(function(e){return u.loading=!1,s(e),o("error",s)})):s("Please correct the form")):void 0},x=function(){return u.form.agreed=!u.form.agreed,A()},S=function(e){return e.required||e.pattern||e.minlength||e.maxlength||e.phone},k=function(e,n){switch(!1){case!n.required:return e+" is required"
case!n.pattern:return"Please follow the example "+C[e].example
...
default:return"please check "+e}},C={email:{pattern:/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i,example:"nickname@email.com",placeholder:"Email"},name:{pattern:"",example:"Your name",placeholder:"Name"},phone:{pattern:/^[0-9]{3}[-][0-9]{3}[-][0-9]{3,5}$/i,placeholder:"Phone +1 123-456-1234",example:"+1 123-456-1234"},address:{pattern:"",example:"Address",placeholder:"Home address"},notes:{pattern:"",example:"Notes",placeholder:"Notes"},card:{pattern:/[0-9]{4} [0-9]{4} [0-9]{4} [0-9]{4}/i,example:"0000 0000 0000 0000",placeholder:"Card #"},expDate:{pattern:/[0-9]{2}\/[0-9]{2}/i,example:"05/15",placeholder:"Exp date"},startDate:{},cvv:{pattern:/[0-9]{3,4}/i,example:"000",placeholder:"CVV"}},A=function(){return u.form.agreed?u.triedCheckout=!0:void 0},T=function(e,n){var t,r,a,o,i,c,l
if(u.triedCheckout===!0){for(t in C)if(C.hasOwnProperty(t)&&(r=null!=(a=e[t])?a.$error:void 0,r&&S(r)))return t===n?k(t,r):""
return""}for(t in C)if(C.hasOwnProperty(t)&&(r=null!=(o=e[t])?o.$error:void 0,r&&S(r)&&r.maxlength))return t===n?k(t,r):""
return u.typingInput===n&&null!=(null!=(i=e[n])&&null!=(c=i.$error)?c.pattern:void 0)&&(null!=(l=C[n].example)?l.length:void 0)>0?"example: "+C[n].example:void 0},M=function(e){return u.typingInput===e?C[e].example:C[e].placeholder},a(function(){var e,n
return e=u.form,e.email="test@debug.com",e.name="Test User",e.phone="+380665243646",e.address="664 Cypress Lane, Campbell, CA, United States",e.notes="Some test notes",n=u.form.creditCard,n.card="5105 1051 0510 5100",n.expDate="05/17",n.cvv="333",u.form.agreed=!0}),I=u,I.investigateDate=c,I.placeholder=M,I.closeError=d,I.checkout=$,I.agree=x,I.fields=C,I.few=p,I.expDateChanged=g,I.cardChanged=b,I.disabledOrder=h,I.typing=f,I.message=T,u}}),angular.module("ablsdk").service("browser",function(e){var n
...
return"unknown"},{name:n()}}),angular.module("ablsdk").service("abldate",function(e){return function(n){var t,r
...
angular.module("ablsdk").service("crud",function(e,n,t,r,a,o,u){return function(i,c){var l,s,d,f,m,p,v,h,y,g,b,D,w,$,x,S,k,C
...
if(!s.loading)return a={title:"Confirm Delete",content:"Are you sure you want to delete this item?",ok:"Confirm",cancel:"Cancel"},r.show(r.confirm().title(null!=(o=null!=t?t.title:void 0)?o:a.title).content(null!=(o=null!=t?t.content:void 0)?o:a.content).ok(null!=(o=null!=t?t.ok:void 0)?o:a.ok).cancel(null!=(o=null!=t?t.cancel:void 0)?o:a.cancel).targetEvent(n)).then(function(){return f.remove(e)},function(){})},k=[],C=function(e){var n,t
return n=[],t=curry$(function(t,r){var a,o
return a=[],C(a),o=function(){var n
...
default:return"undefined"!=typeof console&&null!==console&&null!=(t=console.log)?t.apply(console,arguments):void 0}}}),angular.module("ablsdk").filter("mdate",function(e){return function(e,n){return null!=e?e.format(n):null}}),angular.module("ablsdk").service("formula",function(e,n){var t,r
...
return e.map(function(e){return e.amount})(e.filter(function(e){return"active"===e.status})(null!=(t=null!=n?n.charges:void 0)?t:[]))},u=r(n.timeslots.map(a)),i=r(n.timeslots.map(o)),c=function(e){return Math.max.apply(Math,e)},l=function(){switch(!1){case!(u.length>0):return c(u)
...
return t("Youth",null!=e&&null!=(n=e.timeslots)?n[0]:void 0)}}}),angular.module("ablsdk").service("p",function(){var e
...
return e=arguments,n(function(){return r.apply(null,e)})},null!=t.parent?t.parent.prefill=t.prefill:void 0})}}),angular.module("ablsdk").service("ablfacade",function(e,n){return function(t,r){var a,o
return a=e(t,r),o=n(t,a.calendar),{book:a,slot:o}}}),angular.module("ablsdk").service("safeApply",function(e){return function(n){var t
return t=e.$$phase,"$apply"===t||"$digest"===t?n():e.$apply(n)}}),angular.module("ablsdk").factory("stripe",function(e,n){var t,r
...
default:return r()}}()}),angular.module("ablsdk",[]),angular.module("ablsdk").service("ablcalc",function(e,n){var t
return t=function(e){switch(!1){case"undefined"!=typeof e:return 0
case null!==typeof e:return 0
case 0!==e.length:return 0
default:return e.reduce(function(e,n){return e+n})}},function(r){var a,o,u,i,c,l,s,d,f,m,p,v,h,y,g,b,D
