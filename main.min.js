...
return e}}function curry$(t,n){var e,r=function(a){return t.length>1?function(){var u=a?a.concat():[]
return e=n?e||this:this,u.push.apply(u,arguments)<t.length&&arguments.length?r.call(e,u):t.apply(e,u)}:t}
return r()}angular.module("ablsdk",[]),angular.module("ablsdk").service("ablcalc",function(t,n){var e
...
return"unknown"},{name:n()}}),angular.module("ablsdk").service("ablapi",function(t){return{timeslots:function(n){var e
...
return u=moment(a).tz(n),t("timezone",n),r(u,u),e(u,moment(a)).toDate()}}}}),angular.module("ablsdk").filter("mdate",function(t){return function(t,n){return null!=t?t.format(n):null}}),angular.module("ablsdk").service("ablslot",function(abldate,ablcalc,ablapi,formula,p,debug){return function(activity,model){var transformCharge,state,x$,ref$,getDay,newDate,generateCalendar,getMonth,hackDate,merge,makeAvailable,performChooseSlot,actualEvent,isEmpty,slotsByDay,select,isFitToSlot,isNotFitToAnySlot,inPast,createMonth,startMonth,setCalendars,scroll,nextMonth,calendar,loadEvents,isDummy,isDisabledDay,selectDay,notSelected,disabledSlot,notAvailableSlot,close,chooseSlot,isActiveDay,isDisabledMonth,isActiveMonth,isCalendarUpDisabled,calendarUp,calendarDown,y$
...
return available=slot.available-eval([0].concat(state.model.attendees.map(function(t){return t.quantity})).join("+"))+1,debug({available:slot.available,taken:eval([0].concat(state.model.attendees.map(function(t){return t.quantity})).join("+"))+1,result:available}),available}),performChooseSlot=function(t){var n,e,r,a,u
