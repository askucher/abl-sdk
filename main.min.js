...
return e}}function bind$(t,n,e){return function(){return(e||t)[n].apply(t,arguments)}}function curry$(t,n){var e,r=function(a){return t.length>1?function(){var u=a?a.concat():[]
return e=n?e||this:this,u.push.apply(u,arguments)<t.length&&arguments.length?r.call(e,u):t.apply(e,u)}:t}
return r()}function curry$(t,n){var e,r=function(a){return t.length>1?function(){var u=a?a.concat():[]
return e=n?e||this:this,u.push.apply(u,arguments)<t.length&&arguments.length?r.call(e,u):t.apply(e,u)}:t}
return r()}function bind$(t,n,e){return function(){return(e||t)[n].apply(t,arguments)}}function curry$(t,n){var e,r=function(a){return t.length>1?function(){var u=a?a.concat():[]
...
return e=$.param({activity:n.activityId,dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),t.get("timeslots?"+e)}}}),angular.module("ablsdk").service("ablcalc",function(t){var n
return n=function(t){switch(!1){case"undefined"!=typeof t:return 0
case null!==typeof t:return 0
case 0!==t.length:return 0
default:return t.reduce(function(t,n){return t+n})}},function(e){var r,a,u,o,i,c,l,s,f,d,m,p,v,h
return r=function(t){var n
return{name:t.name,quantity:null!=(n=t.count)?n:0,amount:t.amount,_id:t._id}},a=function(t,n){return n.amount-t.amount},u={attendees:null!=e?e.filter(function(t){return"aap"===t.type}).map(r).sort(a):void 0,addons:null!=e?e.filter(function(t){return"addon"===t.type}).map(r):void 0},o=function(){return n(u.attendees.map(s))+m()},i=function(t){switch(!1){case"tax"!==t.type:return o()/100*t.amount
case"fee"!==t.type:return n(u.attendees.map(function(t){return t.quantity}))*t.amount
default:return 0}},c=function(){return n(e.map(i))},l=function(t){var n,r,a
return null!=(n=null!=(r=e.filter(function(n){return"aap"===n.type&&n.name===t.name}))&&null!=(a=r[0])?a.amount:void 0)?n:0},s=function(t){return l(t)*t.quantity},f=function(t){return n(u.addons.filter(function(n){return n.name===t.name}).map(function(t){return t.amount}))},d=function(t){return f(t)*t.quantity},m=function(){return n(u.addons.map(d))},p=function(){var t,n,e
return t=o(),n=function(){switch(!1){case!(h.codes[0].amountOff<t):return h.codes[0].amountOff
...
default:return 0}}()},v=function(){return o()+c()-p()},h={codes:[],calc:p,remove:function(t){var n
...
return h.error=null!=(n=null!=t&&null!=(e=t.errors)?e[0]:void 0)?n:"Coupon not found"})},code:""},{coupon:h,addons:u.addons,attendees:u.attendees,totalWithoutTaxesfees:o,calcCoupon:p,calcTaxFee:i,calcTaxesFees:c,showPrice:l,calcPrice:s,showAddonPrice:f,calcAddonPrice:d,totalAddons:m,calcSubtotal:o,calcTotal:v}}}),angular.module("ablsdk").service("abldate",function(t){return function(n){var e,r
...
if(!l.loading)return t=Array.prototype.splice.apply(v,arguments),t.forEach(f.remove)},A=function(t,n,e){var a,u
if(!l.loading)return a={title:"Deletion",content:"Are you that you want to delete this item?",ok:"Confirm",cancel:"Cancel"},r.show(r.confirm().title(null!=(u=null!=e?e.title:void 0)?u:a.title).content(null!=(u=null!=e?e.content:void 0)?u:a.content).ok(null!=(u=null!=e?e.ok:void 0)?u:a.ok).cancel(null!=(u=null!=e?e.cancel:void 0)?u:a.cancel).targetEvent(n)).then(function(){return f.remove(t)},function(){})},T=[],M=function(t){var n,e
return n=[],e=curry$(function(e,r){var a,u
return a=[],M(a),u=function(){var n
...
return o=function(){return a(function(){return n.forEach(function(t){return t()})})},null!=r?(T.push({array:r[e],func:o}),r.$watch(e,o,!0)):(T.push({array:e,func:o}),u.watch(e,o)),t},t.watch(t),["map","filter"].forEach(function(n){return t[n]=e(n)}),t.push=D,t.save=y,t.fetch=w,t.remove=A,t.splice=S,t.toArray=function(){return angular.copy(t)}},v.listen=function(t){return t.$on("$destroy",function(){var t,n,e,r,a=[]
for(t=0,e=(n=T).length;e>t;++t)r=n[t],a.push(u.unwatch(r.array,r.func))
return a}),v},M(v),v}}),angular.module("ablsdk").service("browser",function(t){var n
...
default:return"undefined"!=typeof console&&null!==console&&null!=(e=console.log)?e.apply(console,arguments):void 0}}}),angular.module("ablsdk").service("safeApply",function(t){return function(n){var e
return e=t.$$phase,"$apply"===e||"$digest"===e?n():t.$apply(n)}}),angular.module("ablsdk").service("formula",function(t,n){var e,r
...
return e("Youth",null!=t&&null!=(n=t.timeslots)?n[0]:void 0)}}}),angular.module("ablsdk").service("p",function(){var t
...
default:return r()}}()}),angular.module("ablsdk").service("ablslot",function(abldate,ablcalc,ablapi,formula,p){return function(activity,model){var state,getDay,newDate,generateCalendar,getMonth,hackDate,merge,makeAvailable,performChooseSlot,actualEvent,isEmpty,slotsByDay,select,isFitToSlot,isNotFitToAnySlot,inPast,createMonth,startMonth,setCalendars,scroll,nextMonth,calendar,loadEvents,isDummy,isDisabledDay,selectDay,notSelected,disabledSlot,notAvailableSlot,close,chooseSlot,isActiveDay,isDisabledMonth,isActiveMonth,isCalendarUpDisabled,calendarUp,calendarDown,x$
return state={slots:[],model:model,calendars:[],activeSlots:[]},getDay=function(t){var n
return null===t||(n=null!=(null!=t?t.format:void 0)?t:moment(t)),parseInt(n.format("YYYYMMDD"))},newDate=function(){var t,n
return t=moment.apply(null,arguments).tz(activity.timeZone),n=moment().tz(tz),t},generateCalendar=function(t,n){var e,r,a,u,o,i,c,l
...
return e=null!=t?t:hackDate(t,moment()),r=null!=n?n:hackDate(n,moment()),moment([e.year(),e.month(),e.date(),r.hours(),r.minutes(),0])},makeAvailable=curry$(function(slot,arg){return slot.available-eval([0].concat(state.model.attendees.map(function(t){return t.quantity})).join("+"))}),performChooseSlot=function(t){var n,e,r,a,u
