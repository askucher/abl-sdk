...
return"unknown"},{name:n()}}),angular.module("ablsdk").service("abldate",function(t){return function(n){var e,r
...
default:return"undefined"!=typeof console&&null!==console&&null!=(e=console.log)?e.apply(console,arguments):void 0}}}),angular.module("ablsdk").filter("mdate",function(t){return function(t,n){return null!=t?t.format(n):null}}),angular.module("ablsdk").service("p",function(){var t
...
return n},sort:function(t){return t.concat().sort(function(t,n){return t>n?1:n>t?-1:0})},sortWith:curry$(function(t,n){return n.concat().sort(t)}),sortBy:curry$(function(t,n){return n.concat().sort(function(n,e){return t(n)>t(e)?1:t(n)<t(e)?-1:0})}),reverse:function(t){return t.concat().reverse()}}})
var toString$={}.toString
...
return a}),v},T(v),v}}),angular.module("ablsdk").service("safeApply",function(t){return function(n){var e
...
default:return r()}}()}),angular.module("ablsdk").service("ablslot",function(abldate,ablcalc,ablapi,formula,p){return function(activity,model){var transformCharge,state,x$,ref$,getDay,newDate,generateCalendar,getMonth,hackDate,merge,makeAvailable,performChooseSlot,actualEvent,isEmpty,slotsByDay,select,isFitToSlot,isNotFitToAnySlot,inPast,createMonth,startMonth,setCalendars,scroll,nextMonth,calendar,loadEvents,isDummy,isDisabledDay,selectDay,notSelected,disabledSlot,notAvailableSlot,close,chooseSlot,isActiveDay,isDisabledMonth,isActiveMonth,isCalendarUpDisabled,calendarUp,calendarDown,y$
...
return e("Youth",null!=t&&null!=(n=t.timeslots)?n[0]:void 0)}}}),angular.module("ablsdk",[]),angular.module("ablsdk").service("ablapi",function(t){return{timeslots:function(n){var e
return e=$.param({activity:n.activityId,dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),t.get("timeslots?"+e)}}}),angular.module("ablsdk").service("ablcalc",function(t){var n
return n=function(t){switch(!1){case"undefined"!=typeof t:return 0
case null!==typeof t:return 0
case 0!==t.length:return 0
