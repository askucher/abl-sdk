...
return function(){var n,t
for(t=e[0].apply(this,arguments),n=1;n<e.length;++n)t=e[n](t)
return t}}angular.module("ablsdk",[]),angular.module("ablsdk").service("ablapi",function(e){return{timeslots:function(n){var t
return t=$.param({activity:n.activityId,dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),e.get("timeslots?"+t)}}})
var toString$={}.toString
angular.module("ablsdk").service("crud",function(e,n,t,r,a,o){return function(u,i){var c,l,s,d,f,m,p,v,h,y,g,b,D,w,x,S,k,A
return c=u.split("@"),u=c[0],l={loading:!1},s={localStorage:{remove:function(e){},add:function(e){},update:function(e){},fetch:function(e){}},memory:{remove:function(e){return h(e)},add:function(e,n){return Array.prototype.push.call(v,e),"function"==typeof n?n(e):void 0},update:function(e,n){return"function"==typeof n?n(e):void 0},fetch:function(){return l.loading=!1}},backend:{remove:function(n){return e["delete"](u+"/"+n._id).success(function(){return h(n)})},update:function(n,t){return e.update(u+"/"+n._id,n).success(function(e){return l.loading=!1,"function"==typeof t?t(e):void 0})},add:function(n,r){return e.create(u,n).success(function(e){return t("backend-success",e),D(e),"function"==typeof r?r(e):void 0})},fetch:function(){return t("fetch",m(u),v.options),e.get(m(u),{params:v.options}).success(function(e,n,t){var r,a
return v.length=0,r=function(e){var n,r
return n=t()[e],null!=n?(r=document.createElement("a"),r.href=t()[e],JSON.parse('{"'+decodeURI(r.search.substr(1,2e3)).replace(/"/g,'\\"').replace(/&/g,'","').replace(/=/g,'":"')+'"}')):void 0},v.options.total=(a=r("x-last-page-url"),null!=a?parseInt(a.page)*parseInt(a.pageSize):e.length),v.options.pageSize=(a=r("x-first-page-url"),null!=a?parseInt(a.pageSize):e.length),l.loading=!1,D(e)})}}},d=s[null!=(f=c[1])?f:"backend"],m=function(e){var n
for(n in v.urlOptions)e=e.replace(":"+n,v.urlOptions[n])
return e},p=n.$new(),p.items=[],v=p.items,l.loading=!1,h=function(e){var n
return n=v.indexOf(e),n>-1?Array.prototype.splice.call(v,n,1):void 0},y=function(e,n){return null!=e._id?g(e,n):b(e,n)},g=function(e,n){return l.loading?void 0:d.update(e,n)},b=function(e,n){return l.loading?void 0:d.add(e,n)},D=function(e){var n
return n=function(){switch(!1){case"Array"!==toString$.call(e).slice(8,-1):return e
case"Array"!==toString$.call(e[u]).slice(8,-1):return e[u]
case"Object"!==toString$.call(e).slice(8,-1):return[e]
default:return[]}}(),Array.prototype.push.apply(v,n),l.loading=!1},v.options={},v.urlOptions={},w=function(e){if(!l.loading){switch(toString$.call(e).slice(8,-1)){case"Function":return w(e())
case"Number":v.options.page=e
break
case"Object":v.urlOptions=$.extend({},"function"==typeof e.$url?e.$url({},v.options.urlOptions):void 0),delete e.$url,v.options=$.extend({},e,v.options)}return l.loading=!0,null!=v.options.page&&(1===v.options.page?delete v.options.page:v.options.page-=1),d.fetch()}},w(i),x=function(){var e
if(!l.loading)return e=Array.prototype.splice.apply(v,arguments),e.forEach(d.remove)},S=function(e,n,t){var a,o
if(!l.loading)return a={title:"Confirm Delete",content:"Are you sure you want to delete this item?",ok:"Confirm",cancel:"Cancel"},r.show(r.confirm().title(null!=(o=null!=t?t.title:void 0)?o:a.title).content(null!=(o=null!=t?t.content:void 0)?o:a.content).ok(null!=(o=null!=t?t.ok:void 0)?o:a.ok).cancel(null!=(o=null!=t?t.cancel:void 0)?o:a.cancel).targetEvent(n)).then(function(){return d.remove(e)},function(){})},k=[],A=function(e){var n,t
return n=[],t=curry$(function(t,r){var a,o
return a=[],A(a),o=function(){var n
return n=Array.prototype[t].call(e,r),a.length=0,Array.prototype.push.apply(a,n)},n.push(o),o(),a}),e.loading=function(){return l.loading},e.toArray=function(){var n
return n=[],Array.prototype.push.apply(n,e),n},e.watch=function(t,r){var u
return u=function(){return a(function(){return n.forEach(function(e){return e()})})},null!=r?(k.push({array:r[t],func:u}),r.$watch(t,u,!0)):(k.push({array:t,func:u}),o.watch(t,u)),e},e.watch(e),["map","filter"].forEach(function(n){return e[n]=t(n)}),e.push=b,e.save=y,e.fetch=w,e.remove=S,e.splice=x,e.toArray=function(){return angular.copy(e)}},v.listen=function(e){return e.$on("$destroy",function(){var e,n,t,r,a=[]
for(e=0,t=(n=k).length;t>e;++e)r=n[e],a.push(o.unwatch(r.array,r.func))
return a}),v},A(v),v}}),angular.module("ablsdk").service("browser",function(e){var n
...
return"unknown"},{name:n()}}),angular.module("ablsdk").service("ablbook",function(e,n,t,r,a,o){return function(r,o){var u,i,c,l,s,d,f,m,p,v,h,y,g,b,D,w,$,x,S,k,A,C,M,T,O
...
default:return"same"}}()},l=function(e){return!u.loading&&e.$valid},s=function(e){return u.form.error=e},d=function(){return s("")},f=function(e){return u.triedCheckout=!1,u.typing=e},m=function(){var e
...
return s(null!=(n=null!=(t=e.errors)?t[0]:void 0)?n:"Server error")})["finally"](function(){return u.loading=!1}))}))},w=function(){return e.get("payments/setup")},$=function(e){return u.loading!==!0?(u.triedCheckout=!0,l(e)?(u.loading=!0,w().success(function(e){return D(e.publicKey,function(){return o("success",e)})}).error(function(e){return u.loading=!1,s(e),o("error",s)})):s("Please correct the form")):void 0},x=function(){return u.form.agreed=!u.form.agreed,C()},S=function(e){return e.required||e.pattern||e.minlength||e.maxlength||e.phone},k=function(e,n){switch(!1){case!n.required:return e+" is required"
case!n.pattern:return"Please follow the example "+A[e].example
...
default:return"please check "+e}},A={email:{pattern:/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i,example:"nickname@email.com",placeholder:"Email"},name:{pattern:"",example:"Your name",placeholder:"Name"},phone:{pattern:/^[0-9]{3}[-][0-9]{3}[-][0-9]{3,5}$/i,placeholder:"Phone +1 123-456-1234",example:"+1 123-456-1234"},address:{pattern:"",example:"Address",placeholder:"Home address"},notes:{pattern:"",example:"Notes",placeholder:"Notes"},card:{pattern:/[0-9]{4} [0-9]{4} [0-9]{4} [0-9]{4}/i,example:"0000 0000 0000 0000",placeholder:"Card #"},expDate:{pattern:/[0-9]{2}\/[0-9]{2}/i,example:"05/15",placeholder:"Exp date"},startDate:{},cvv:{pattern:/[0-9]{3,4}/i,example:"000",placeholder:"CVV"}},C=function(){return u.form.agreed?u.triedCheckout=!0:void 0},M=function(e,n){var t,r,a,o,i,c,l
if(u.triedCheckout===!0){for(t in A)if(A.hasOwnProperty(t)&&(r=null!=(a=e[t])?a.$error:void 0,r&&S(r)))return t===n?k(t,r):""
return""}for(t in A)if(A.hasOwnProperty(t)&&(r=null!=(o=e[t])?o.$error:void 0,r&&S(r)&&r.maxlength))return t===n?k(t,r):""
return u.typing===n&&null!=(null!=(i=e[n])&&null!=(c=i.$error)?c.pattern:void 0)&&(null!=(l=A[n].example)?l.length:void 0)>0?"example: "+A[n].example:void 0},T=function(e){return u.typing===e?A[e].example:A[e].placeholder},a(function(){var e,n
return e=u.form,e.email="test@debug.com",e.name="Test User",e.phone="+380665243646",e.address="664 Cypress Lane, Campbell, CA, United States",e.notes="Some test notes",n=u.form.creditCard,n.card="5105 1051 0510 5100",n.expDate="05/17",n.cvv="333",u.form.agreed=!0}),O=u,O.investigateDate=c,O.placeholder=T,O.closeError=d,O.checkout=$,O.agree=x,O.fields=A,O.few=p,O.expDateChanged=g,O.cardChanged=b,O.disabledOrder=h,O.typing=f,O.message=M,u}}),angular.module("ablsdk").service("ablcalc",function(e,n){var t
...
if(0!==(null!=(r=g.code)?r:"").length)return g.error="",a=function(e){var r
...
default:return"undefined"!=typeof console&&null!==console&&null!=(t=console.log)?t.apply(console,arguments):void 0}}}),angular.module("ablsdk").service("abldate",function(e){return function(n){var t,r
...
return o=moment(a).tz(n),e("timezone",n),r(o,o),t(o,moment(a)).toDate()}}}}),angular.module("ablsdk").filter("mdate",function(e){return function(e,n){return null!=e?e.format(n):null}}),angular.module("ablsdk").service("p",function(){var e
...
return t=e.$$phase,"$apply"===t||"$digest"===t?n():e.$apply(n)}}),angular.module("ablsdk").service("formula",function(e,n){var t,r
...
return available=slot.available-eval([0].concat(model.calc.attendees.map(function(e){return e.quantity})).join("+"))}),performChooseSlot=function(e){var n,t,r,a,o,u,i
...
default:return r()}}()}),angular.module("ablsdk",[]),angular.module("ablsdk").service("ablapi",function(e){return{timeslots:function(n){var t
return t=$.param({activity:n.activityId,dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),e.get("timeslots?"+t)}}})
var toString$={}.toString
angular.module("ablsdk").service("crud",function(e,n,t,r,a,o){return function(u,i){var c,l,s,d,f,m,p,v,h,y,g,b,D,w,x,S,k,A
return c=u.split("@"),u=c[0],l={loading:!1},s={localStorage:{remove:function(e){},add:function(e){},update:function(e){},fetch:function(e){}},memory:{remove:function(e){return h(e)},add:function(e,n){return Array.prototype.push.call(v,e),"function"==typeof n?n(e):void 0},update:function(e,n){return"function"==typeof n?n(e):void 0},fetch:function(){return l.loading=!1}},backend:{remove:function(n){return e["delete"](u+"/"+n._id).success(function(){return h(n)})},update:function(n,t){return e.update(u+"/"+n._id,n).success(function(e){return l.loading=!1,"function"==typeof t?t(e):void 0})},add:function(n,r){return e.create(u,n).success(function(e){return t("backend-success",e),D(e),"function"==typeof r?r(e):void 0})},fetch:function(){return t("fetch",m(u),v.options),e.get(m(u),{params:v.options}).success(function(e,n,t){var r,a
