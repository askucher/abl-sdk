...
return u=moment(a).tz(n),t("timezone",n),r(u,u),e(u,moment(a)).toDate()}}}}),angular.module("ablsdk").service("ablcalc",function(t,n){var e
...
return available=slot.available+1-eval([0].concat(state.model.calc.attendees.map(function(t){return t.quantity})).join("+")),debug({available:slot.available+1,taken:eval([0].concat(state.model.calc.attendees.map(function(t){return t.quantity})).join("+")),result:available}),available}),performChooseSlot=function(t){var n,e,r,a,u
