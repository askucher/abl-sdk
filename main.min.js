...
return e=u.form,e.email="test@debug.com",e.name="Test User",e.phone="+380665243646",e.address="664 Cypress Lane, Campbell, CA, United States",e.notes="Some test notes",n=u.form.creditCard,n.card="5105 1051 0510 5100",n.expDate="05/17",n.cvv="333",u.form.agreed=!0}),I=u,I.investigateDate=c,I.placeholder=T,I.closeError=d,I.checkout=$,I.agree=x,I.fields=k,I.few=p,I.expDateChanged=g,I.cardChanged=b,I.disabledOrder=h,I.typing=f,I.message=M,u}})
...
return a}),h},k(h),h}}),angular.module("ablsdk").service("ablcalc",function(e,n){var t
...
return o=moment(a).tz(n),e("timezone",n),r(o,o),t(o,moment(a)).toDate()}}}}),angular.module("ablsdk").service("browser",function(e){var n
...
return"unknown"},{name:n()}}),angular.module("ablsdk").service("formula",function(e,n){var t,r
...
return t("Youth",null!=e&&null!=(n=e.timeslots)?n[0]:void 0)}}}),angular.module("ablsdk").service("ablapi",function(e){return{timeslots:function(n){var t
return t=$.param({activity:n.activityId,"status[event]":"all",dateRange:[moment(n.startTime).clone().startOf("day").startOf("month").toISOString(),moment(n.endTime).clone().startOf("day").endOf("month").endOf("day").toISOString()]}),e.get("timeslots?"+t)}}}),angular.module("ablsdk").service("p",function(){var e
...
default:return"undefined"!=typeof console&&null!==console&&null!=(t=console.log)?t.apply(console,arguments):void 0}}}),angular.module("ablsdk").filter("mdate",function(e){return function(e,n){return null!=e?e.format(n):null}}),angular.module("ablsdk").service("ablslot",function(abldate,ablcalc,ablapi,formula,p,debug,$xabl){return function(activity,inputModel){var transformCharge,getDay,newDate,generateCalendar,getMonth,hackDate,merge,makeAvailable,performChooseSlot,actualEvent,isEmpty,slotsByDay,select,isFitToSlot,isNotFitToAnySlot,inPast,createMonth,startMonth,setCalendars,scroll,nextMonth,calendar,loadEvents,isDummy,isDisabledDay,selectDay,notSelected,disabledSlot,notAvailableSlot,close,chooseSlot,isActiveDay,isDisabledMonth,isActiveMonth,isCalendarUpDisabled,calendarUp,calendarDown,setup,move,createEventInstanceId,model,slots,calendars,activeSlots,x$,ref$
...
return e=arguments,n(function(){return r.apply(null,e)})},null!=t.parent?t.parent.prefill=t.prefill:void 0})}}),angular.module("ablsdk").factory("stripe",function(e,n){var t,r
